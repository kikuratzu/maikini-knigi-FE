...
(function () {
  ...
  var GENRES = [
    { id: "fiction", name: "Fiction", color: "#b8653d" },
    { id: "classics", name: "Classics", color: "#2f5d50" },
    { id: "fantasy", name: "Fantasy & Sci-Fi", color: "#4b4a7a" },
    { id: "nonfiction", name: "Non-fiction", color: "#8a6d3b" },
    { id: "children", name: "Children", color: "#d49a3a" },
    { id: "bulgarian", name: "Bulgarian authors", color: "#8e3b46" }
  ];
  var GENRE_BY_ID = {};
  ...
  var BOOKS = [
    { id: "time-shelter", title: "Time Shelter", author: "Georgi Gospodinov", genre: "bulgarian", year: 2020, format: "Paperback", price: 1890, badge: "pick", cover: ["#8e3b46", "#f6e7d8", "circle"],
    ...
    { id: "midnight-library", title: "The Midnight Library", author: "Matt Haig", genre: "fiction", year: 2020, format: "Paperback", price: 1490, badge: "best", cover: ["#1f3b57", "#f2d38a", "arch"],
    ...
    { id: "pride-and-prejudice", title: "Pride and Prejudice", author: "Jane Austen", genre: "classics", year: 1813, format: "Hardcover", price: 1690, badge: "", cover: ["#2f5d50", "#f3ead8", "frame"],
    ...
    { id: "dune", title: "Dune", author: "Frank Herbert", genre: "fantasy", year: 1965, format: "Paperback", price: 1790, badge: "best", cover: ["#c7793a", "#2a1c12", "circle"],
    ...
    { id: "sapiens", title: "Sapiens", author: "Yuval Noah Harari", genre: "nonfiction", year: 2011, format: "Paperback", price: 1990, badge: "", cover: ["#e9e2d4", "#23312b", "band"],
    ...
    { id: "little-prince", title: "The Little Prince", author: "Antoine de Saint-Exupéry", genre: "children", year: 1943, format: "Hardcover", price: 1290, badge: "", cover: ["#3d6fa0", "#f7e08a", "circle"],
    ...
    { id: "under-the-yoke", title: "Under the Yoke", author: "Ivan Vazov", genre: "bulgarian", year: 1894, format: "Paperback", price: 1590, badge: "", cover: ["#5b3a2e", "#ecd9b8", "frame"],
    ...
    { id: "hundred-years", title: "One Hundred Years of Solitude", author: "Gabriel García Márquez", genre: "classics", year: 1967, format: "Paperback", price: 1790, badge: "", cover: ["#d9a441", "#2a2016", "stripe"],
      desc: "Seven generations of the Buendía family in the town of Macondo, told with humour, magic and unforgettable imagination." },
    { id: "hobbit", title: "The Hobbit", author: "J. R. R. Tolkien", genre: "fantasy", year: 1937, format: "Hardcover", price: 1890, badge: "", cover: ["#355e3b", "#e8d7a8", "arch"],
    ...
    { id: "atomic-habits", title: "Atomic Habits", author: "James Clear", genre: "nonfiction", year: 2018, format: "Paperback", price: 1790, badge: "best", cover: ["#f1ede4", "#1f2a24", "stripe"],
      desc: "A practical guide to building good habits and breaking bad ones through small, steady changes that add up over time." },
    { id: "master-and-margarita", title: "The Master and Margarita", author: "Mikhail Bulgakov", genre: "classics", year: 1967, format: "Paperback", price: 1590, badge: "", cover: ["#1f1f2e", "#d9b25f", "circle"],
    ...
    { id: "norwegian-wood", title: "Norwegian Wood", author: "Haruki Murakami", genre: "fiction", year: 1987, format: "Paperback", price: 1490, badge: "", cover: ["#6f8f5e", "#f4efe2", "band"],
    ...
    { id: "physics-of-sorrow", title: "The Physics of Sorrow", author: "Georgi Gospodinov", genre: "bulgarian", year: 2011, format: "Paperback", price: 1690, badge: "", cover: ["#2e4f6b", "#f0d9b5", "arch"],
    ...
    { id: "hungry-caterpillar", title: "The Very Hungry Caterpillar", author: "Eric Carle", genre: "children", year: 1969, format: "Board book", price: 990, badge: "", cover: ["#7cb342", "#c62f2f", "circle"],
    ...
    { id: "name-of-the-rose", title: "The Name of the Rose", author: "Umberto Eco", genre: "classics", year: 1980, format: "Paperback", price: 1790, badge: "", cover: ["#6b2d2d", "#ead7b0", "frame"],
    ...
    { id: "educated", title: "Educated", author: "Tara Westover", genre: "nonfiction", year: 2018, format: "Paperback", price: 1690, badge: "new", cover: ["#c9d6cf", "#1f2a24", "arch"],
      desc: "A memoir of a young woman who grew up without school in rural Idaho and went on to earn a PhD from Cambridge." },
    { id: "philosophers-stone", title: "Harry Potter and the Philosopher's Stone", author: "J. K. Rowling", genre: "children", year: 1997, format: "Paperback", price: 1390, badge: "", cover: ["#7a1f2b", "#e6c46a", "stripe"],
      desc: "On his eleventh birthday, Harry learns he is a wizard and sets off for Hogwarts School of Witchcraft and Wizardry." },
    { id: "nineteen-eighty-four", title: "1984", author: "George Orwell", genre: "classics", year: 1949, format: "Paperback", price: 1290, badge: "", cover: ["#c0392b", "#f5f1ea", "band"],
    ...
    { id: "thinking-fast-slow", title: "Thinking, Fast and Slow", author: "Daniel Kahneman", genre: "nonfiction", year: 2011, format: "Paperback", price: 1990, badge: "", cover: ["#f3efe6", "#2f5d50", "circle"],
    ...
    { id: "crime-and-punishment", title: "Crime and Punishment", author: "Fyodor Dostoevsky", genre: "classics", year: 1866, format: "Paperback", price: 1490, badge: "", cover: ["#2b2b2b", "#e3c8a0", "frame"],
